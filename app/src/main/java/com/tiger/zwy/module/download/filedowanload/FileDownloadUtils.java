...
public class FileDownloadUtils {
     ...
     * 单任务下载
     */
    public void startDownLoadFileSingle(String downLoadUri, String destinationUri, FileDownLoaderCallBack param) {
        FileDownloader.getImpl().create(downLoadUri).setPath(destinationUri);
    }
