...
public class HooDownloadManager {
    ...
    public HooDownloadManager(Context context, String url) {
        this(context, url, getFileNameByUrl(url));
    }

    public HooDownloadManager(Context context, String url, String name) {
    ...
    public HooDownloadManager setListener(DownloadManagerListener listener) {
