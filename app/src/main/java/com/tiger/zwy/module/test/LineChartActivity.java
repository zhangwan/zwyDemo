...
import com.tiger.zwy.module.test.bean.*;
import com.tiger.zwy.module.test.view.LineChartManager;
import com.tiger.zwy.module.test.view.LocalJsonAnalyzeUtil;
...
public class LineChartActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        //展示图表
        lineChartManager1.showLineChart(incomeBeanList, "我的收益", getResources().getColor(R.color.color_ffcc03));
//        lineChartManager1.addLine(shanghai, "上证指数", getResources().getColor(R.color.color_ffcc03));
