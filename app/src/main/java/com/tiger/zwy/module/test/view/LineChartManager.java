...
import com.tiger.zwy.module.test.bean.CompositeIndexBean;
import com.tiger.zwy.module.test.bean.IncomeBean;
...
//        description.setText("需要展示的内容");
    ...
    public void showLineChart(final List<IncomeBean> dataList, String name, int color) {
        ...
        xAxis.setValueFormatter(new ValueFormatter() {
            @Override
            public String getFormattedValue(float value) {
                int a=(int)value % dataList.size();
                Log.i("i====","===value=="+value);
                Log.i("i====","===setValueFormatter=="+a);
                Log.i("i====","===dataList=="+dataList.size());
